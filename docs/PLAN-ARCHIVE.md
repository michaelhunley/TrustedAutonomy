# Trusted Autonomy — Plan Archive (Phases 0 through v0.8)

> This file contains completed plan phases that have been archived from `PLAN.md` to keep the active plan readable.
> All phases below are `<!-- status: done -->` unless marked otherwise (deferred phases are noted).
